...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        self.sh_degree = 3
        self.feat_dim = 32
        self.language_feat_dim = 32 # language feature dim
        self.n_offsets = 10
        ...
        self._model_path = ""
        self._images = "images"
        self._language_features_name = "language_features_dim3" # language feature name
        self._resolution = -1
        self._white_background = False
        self._feature_level = 1 # language feature level
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.language_feature_lr = 0.0075
        ...
        self.mlp_language_lr_init = 0.008
        self.mlp_language_lr_final = 0.00005
        self.mlp_language_lr_delay_mult = 0.01
        self.mlp_language_lr_max_steps = 30_000
